...
cleardevice();
settextstyle(0,0,1);
outtextxy(10,30,"this is a simple application of landlilne network connect to some group of");
outtextxy(10,50,"offices using prim's algorithm with Minimum spanning tree.The resultant");
outtextxy(0,70,"connection from house to house are in such a way that it choses minimum distance");
setcolor(YELLOW);
...
outtextxy(10,360,"A office wants to lease phone lines to connect them up with each other");
...
outtextxy(10,390,"offices with a minimum total cost.");
while(!kbhit())
{
}
}*/
...
//line(220,240,360,140);
line(510,250,240,140); //diagnal_line
...
delay(200);
setcolor(CYAN);
outtextxy(10,130,"->Step 1: Input:The cost adjacency matrix C and number of vertices n");
delay(200);
outtextxy(10,160,"->Step 2: Output:Minimum weight Spanning Tree T");
delay(200);
outtextxy(100,190,"for(i=1;i<=n;i++)");
delay(200);
outtextxy(100,220,"Visited[i]=0;");
delay(200);
outtextxy(100,250,"U=1");
delay(200);
outtextxy(100,280,"Visited[u]=1;");
delay(200);
outtextxy(100,310,"While(there is still unchosen vertex)do");
delay(200);
outtextxy(10,340,"->Step 3: Let(u,v)be the lightest edge between any chosen u to any chosen vertex v");
delay(200);
outtextxy(100,370,"Visited[v]=1;");
delay(200);
outtextxy(100,400,"T=union(T,<u,v>);");
delay(200);
